        ...
        NstrScaffold(
            ...
            PrimaryButton(text = "SAVE DETAILS", onClick = {
                submitIncident(
                    ...
                    type = "WATER_SOURCE", title = sourceType ?: "Water Source",
                    ...
                    details = mapOf(
                        ...
                        "percent" to percent,
                        "quality" to quality,
                        "humanPresence" to humanPresence,
                        "humanSign" to humanSign,
                        "animalPresence" to animalPresence,
                        "animalSign" to animalSign,
