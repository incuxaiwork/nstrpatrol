...
/**
 * Dashboard (PRD §5) — DISABLED
 *
 * All dashboard code is commented out below. To re-enable, uncomment the
 * implementation and remove the placeholder component.
 */
...
export default function DashboardPage() {
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center text-center">
      <p className="text-lg font-medium text-ink">Dashboard is currently disabled.</p>
      <p className="mt-2 text-sm text-ink-soft">Contact the development team to re-enable.</p>
    </div>
  );
}
