...
export const mockObservations: Observation[] = [
  {
    ...
    title: "Tiger pugmarks near Tummurukota waterhole",
    description: "Fresh pugmarks (approx. 5 x 4.5 cm) found on the eastern bank of the Tummurukota waterhole. Estimated 1-2 days old. Direction of travel north-east towards Pasuvemula.",
    severity: "high", status: "under-review", priority: "urgent",
    division: "d-markapur", range: "r-vp-south", beat: "b-vp-south-tummurukota",
    recordedBy: "Aarav Sharma", recordedAt: minutesAgo(36), patrolId: "p-2026-0118",
    species: "Bengal Tiger", lat: 15.702, lng: 79.461,
    media: [{ type: "photo", label: "Pug marks", captureTime: minutesAgo(38) }],
    actionTaken: "Advisory issued to villages near Tummurukota", related: ["ob-9004"],
  },
  {
    id: "ob-9002", code: "OB-9002", category: "human-impact", subcategory: "Poaching / trapping",
    title: "Snare found at Akkapalem riverine belt",
    ...
    division: "d-markapur", range: "r-y-palem", beat: "b-y-palem-akkapalem",
    recordedBy: "Chandra Mohan", recordedAt: hoursAgo(7), patrolId: "p-2026-0117",
    lat: 15.861, lng: 79.477,
  ...
  },
  {
    ...
    title: "Tummurukota waterhole partially dry",
    ...
    lat: 15.711, lng: 79.472, status: "open",
  ...
  },
  {
    ...
    title: "Herd of 6 elephants near Peddamantanala",
    ...
    division: "d-markapur", range: "r-korraprolu", beat: "b-korraprolu-peddamantanala",
    recordedBy: "Harsh Vardhan", recordedAt: hoursAgo(3), patrolId: "p-2026-0114",
    lat: 15.898, lng: 79.452,
  ...
  },
  {
    ...
    division: "d-markapur", range: "r-nekkanti", beat: "b-nekkanti-nekkanti",
    recordedBy: "Ishita Sengupta", recordedAt: hoursAgo(26),
    lat: 15.902, lng: 79.348,
  ...
  },
  {
    ...
    title: "Burugundala patrol trail blocked",
    description: "Treefall blocking trail near G.V. Palli beat boundary. Access to Korraprolu affected.",
    severity: "low", status: "open",
    division: "d-markapur", range: "r-gv-palli", beat: "b-gv-palli-burugundala",
    recordedBy: "Farhan Ali", recordedAt: hoursAgo(1),
    lat: 15.982, lng: 79.412,
  },
  {
    id: "ob-9008", code: "OB-9008", category: "human-impact", subcategory: "Fire hazard",
    title: "Drunken party trace near V.P. South road",
    description: "Cigarette butts and liquor bottles found near the V.P. South road edge. Silviculture zone at risk from fire outbreak.",
    severity: "high", status: "escalated", priority: "urgent",
    division: "d-markapur", range: "r-vp-south", beat: "b-vp-south-pasuvemula",
    recordedBy: "Ram Verma", recordedAt: hoursAgo(5),
    lat: 15.668, lng: 79.515,
...
export const mockNotifications: NotificationItem[] = [
  { id: "n1", kind: "critical", title: "SOS received — Y. Cherlopalli", body: "Gauri Patil triggered SOS from Y. Cherlopalli boundary. Response team dispatched.", time: minutesAgo(12), module: "Patrol Operations", read: false },
